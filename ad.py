...
def intro():
    ...
    print_pause(f"Rumor has it that a {characters} is somewhere around here, and has been terrifying the nearby village")
...
def house():
    ...
    print_pause(f"You are about to knock when the door opens and out steps a {characters}.")
...
def riddle_2():
    global scoring
    answer =input("I have a face and two hands, but no arms or legs. What am I?\n")
    if answer =="clock":
        print_pause("Amazing")
        scoring+=2
...
def riddle_4():
    global scoring
    answer =input("I’m tall when I’m young, and short when I’m old. What am I?\n")
    if answer =="candle":
        print_pause("Amazing")
        scoring+=2
    else:
